...
const T = {
  it: {
    ...
    waBtn: "INVIA SU WHATSAPP", pdfBtn: "MANUALE MEC",
  ...
  en: {
    ...
    waBtn: "SEND VIA WHATSAPP", pdfBtn: "MEC MANUAL",
      ...
      <header className="header">
        <div className="header-inner">
          ...
          <div className="header-actions">
            ...
            <button className="pdf-header-btn" onClick={openPDF} title="Manuale MEC">📄</button>
          ...
          <div className="result-card">
            ...
            <div className="btn-row">
              ...
              <button className="pdf-btn" onClick={openPDF}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 1.5L18.5 9H13V3.5zM6 20V4h5v7h7v9H6zm2-7h8v1H8v-1zm0 2h8v1H8v-1zm0 2h5v1H8v-1z"/>
                </svg>
                {t.pdfBtn}
              </button>
            </div>
